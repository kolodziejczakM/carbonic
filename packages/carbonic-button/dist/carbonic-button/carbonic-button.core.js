...
(function(s){s&&(resourcesUrl=s.getAttribute('data-resources-url'))})(document.querySelector("script[data-namespace='carbonic-button']"));
/**
 * SSR Attribute Names
 */
...
})(window,document,{},"CarbonicButton","hydrated",[["carbonic-button","carbonic-button",1,[["el",64],["label",1,1,1,2]],1]]);